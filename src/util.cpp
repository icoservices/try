...
int nAnonymizeVersatileVisionCoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\VersatileVisionCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\VersatileVisionCoin
    // Mac: ~/Library/Application Support/VersatileVisionCoin
    // Unix: ~/.VersatileVisioncoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "VersatileVisionCoin";
#else
    fs::path pathRet;
    ...
    return pathRet / "VersatileVisionCoin";
#else
    // Unix
    return pathRet / ".VersatileVisioncoin";
#endif
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "VersatileVisioncoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "VersatileVisioncoind.pid"));
